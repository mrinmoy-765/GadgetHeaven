    ...
    <div>
      <div>
        <div className="text-center">
          ...
          <p className="font-semibold text-gray-500 mt-2">Leading the way in cutting-edge technology and innovation</p>
        </div>
        <div className="divider"></div>
      </div>
      <footer className="footer bg-base-200 text-base-content p-10 grid grid-cols-3 place-items-center">
        <nav>
